...
class TrackMotionController:
    ...
    def _print_controls(self):
        ...
        print("  X + L1        - TRACK MOTION MJLAB (static base, forehand/backhand hitting)")
        print("  Y + L1        - TRACK MOTION MOVABLE BASE (random base y while hitting)")
    ...
    def _set_default_world_state(self):
        # Placeholder world/perception values for track-motion observations.
    ...
    def _print_runtime_status(self):
        ...
        if current_mode == FSMStateName.SKILL_TRACK_MOTION_MJLAB:
            ...
            if now - self._last_track_y_print_time > 0.5:
                ...
                print(f"[TrackMotionMjlab] target_base_y={self.track_static_base_y:+.3f}")
