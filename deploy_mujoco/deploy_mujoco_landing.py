...
TABLE_POLICY_DEFAULT = "track_motion_mjlab"
...
def apply_initial_configuration(model, data, robot_qpos_slice, base_height, ball_pos, ball_vel):
...
def reset_simulation(
    ...
    apply_initial_configuration(model, data, robot_qpos_slice, base_height, ball_pos, ball_vel)
    data.ctrl[:] = 0.0
...
if __name__ == "__main__":
    ...
    print("Keyboard: r=reset, l=loco, t=track_motion_mjlab landing, p=passive")
        ...
        while viewer.is_running():
            ...
            if sim_counter % control_decimation == 0:
                ...
                if fsm_controller.cur_policy.name == FSMStateName.SKILL_TRACK_MOTION_MJLAB:
                    landing_cmd = landing_generator.update(
